...
#define APP_URL         "https://github.com/THZoria/AtmoPackUpdater-Full/releases/latest/download/AtmoPackUpdater.nro"
#define CFW_URL         "https://github.com/Pikatsuto/AtmosphereFullFetcher-cli/releases/latest/download/AtmoPack-Full.zip"
